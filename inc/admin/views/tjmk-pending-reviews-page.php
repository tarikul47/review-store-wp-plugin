 ...
 */
// echo "<pre>";
// print_r($pending_reviews);
?>

<!-- This file should primarily consist of HTML with a little bit of PHP. -->
<div class="wrap">
    <h2><strong><?php esc_html_e('Pending Reviews', 'text-domain'); ?></strong></h2>
                ...
                <?php if (!empty($pending_reviews)): ?>
                    <?php foreach ($pending_reviews as $review): ?>
                        <tr id="post-id-<?php echo esc_attr($review['review_id']); ?>">
                            ...
                            <td class="column-review-by" data-colname="Review by">
                                <?php echo Helper::get_current_user_id_and_roles()['name']; ?>
                            </td>
                            <td class="column-actions" data-colname="">

                                <a class="custom-button button-edit"
                                    href="<?php echo esc_url(admin_url('admin.php?page=tjmk-add-profile&action=edit-review&profile_id=' . esc_attr($review['profile_id']) . '&review_id=' . esc_attr($review['review_id']) . '&return_to=tjmk-pending-review')); ?>"
