    ...
    <div class="container">
        ...
        <div class="header">
            <div class="logo-section">
                <a href="https://tjanstemannakollen.se"><img
                        src="<?php echo PLUGIN_NAME_ASSETS_URI . '/images/logos-white.png' ?>" alt=""></a>
            </div>
            ...
            <div class="header">
                <table>
                    <tbody>
                        <tr>
                            <td class="logo"><img src="./images/logos-white.png" alt=""></td>
                            <td class="order-date">
                                <span>Order Date: 2024-10-20</span><br>
                                <span>Order ID: #8384829</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
